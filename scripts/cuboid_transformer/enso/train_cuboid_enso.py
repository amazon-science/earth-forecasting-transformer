...
class CuboidENSOPLModule(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.log('valid_acc_epoch', valid_acc, prog_bar=True, on_step=False, on_epoch=True)
        self.log('valid_weighted_acc_epoch', valid_weighted_acc, prog_bar=True, on_step=False, on_epoch=True)
    ...
    def test_epoch_end(self, outputs):
        ...
        self.log('test_weighted_acc_epoch', test_weighted_acc, prog_bar=True, on_step=False, on_epoch=True)
